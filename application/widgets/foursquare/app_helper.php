<div id="widget-foursquare-feed-__i__" class="widget widget-wrapper gradient gradient-blue" data-type="foursquare">
		...
		<div class="widget foursquare">
			<div class="panel panel-default widget-testimonials-full">
				<div class="panel-heading">
				  <h3 class="panel-title">Foursquare Feed</h3>
				</div>
	...
	<div class="widget-description">Add Foursquare Feed<p>Grab and move into place.</p></div>
</div>