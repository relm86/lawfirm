...
|
*/
$config['encryption_key'] = 'dfhhutrwbtnsybasdbrasnyaegvbbdSfdsfs';
...
$csrf_off = array(
    $config['base_url'].'login/twitter_callback/',
    $config['base_url'].'ajax/fb_login/',
    $config['base_url'].'ajax/google_login/',
    $config['base_url'].'ajax/linkedin_login/'
);
