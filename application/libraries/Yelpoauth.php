...
class YelpOAuth {
	...
	public $CONSUMER_KEY = 'YnWtVN4UnlGtmVw-vxWyfw';
	public $CONSUMER_SECRET = '2TWWUsEAZF7ZN4bHQfoky5U8TZM';
	public $TOKEN = 't3jCaY6lQoRB0HXqv8yqx2QofgplBYz6';
	public $TOKEN_SECRET = 'hKNdRw8T17Zjq-oSYmLd3AMSyBQ';
	...
	function query_api($term, $location) {
	    ...
	    print "$response\n";
	    */
	    if ( ! isset($response->businesses) || count($response->businesses) < 1)
	    	return FALSE;
