				...
				<div id="widget-faq-__i__" class="widget" data-type="faq">
					...
					<div class="widget-inside">
						...
						<div class="widget faq">
							...
							<div class="blank-widget faqs"><button type="button" class="btn btn-warning edit-widget" data-toggle="modal" data-target="#widget-faq-__i__-modal">Add FAQ</button></div>
						</div>
					</div>
				...
				<div id="widget-links-__i__" class="widget" data-type="links">
					...
					<div class="widget-inside">
						...
						<div class="widget links">
							...
							<div class="blank-widget links"><button type="button" class="btn btn-warning edit-widget" data-toggle="modal" data-target="#widget-links-__i__">Add Links</button></div>
