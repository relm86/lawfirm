	...
	<div class="col-md-12">
  		<div class="panel panel-default">
			...
			<div class="panel-body">
				<?php echo form_open('profile', array('class' => 'form-horizontal', 'id' => 'verify_password') ); ?>
		  		<div class="form-group">
		  			<label class="col-lg-3 control-label"></label>
			  		<div class="col-lg-5">
			  			<div class="alert alert-success" role="alert">Please enter your password to continue update your profile.</div>
			  			<?php
