...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url();?>css/theme-audi2.css" />
  ...
  <div class="row">
    <div class="col-md-12 pL-fix pR-fix">
      <div class="widget-header">
        ...
        <div class="header-chat pull-right"><a href="javascript:void()"><img src="<?php echo base_url(); ?>img/chat-widget.png" width="217" height="86" alt=""/></a></div>
      </div>
    </div>
  </div>