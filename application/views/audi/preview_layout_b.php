		...
		<div class="col-md-10" id="the-page">
						...
						<div class="col-md-6">
							 <div class="widget header">
								<div class="logo pull-left">
									<a href="javascript:void()"><img src="<?php echo base_url(); ?>img/audi-logo.png" alt=""/></a>
								</div>
							</div>
						</div>
						<div class="col-md-3">
				...
				<div class="col-md-12">
					<div class="widget-wrapper">
						<div class="widget-action">
							<span class="glyphicon glyphicon-edit edit-widget" data-toggle="modal" data-target="#main-image-slider"></span>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-8 " id="main-content">
					...
					<div class="widget-wrapper">
						<div class="widget-action">
							<span class="glyphicon glyphicon-edit edit-widget" data-toggle="modal" data-target="#videos-modal"></span>
						</div>
			...
			<div class="row">
				<div class="col-md-12" id="footer-fullwidth">
					<div class="widget external-site">Visit our website <a href="javascript:void()" target="_blank">Audi North Scottsdale</a></div></div>
				</div>
			</div>
			...
			<div class="row" id="footer">
				<div class="col-md-2">
					<div class="widget-container" id="footer1">
						...
						<?php echo draw_widgets($template->id, 'footer1', TRUE); ?>
					</div>
				</div>
				<div class="col-md-2">
					<div class="widget-container" id="footer2">
						<?php echo draw_widgets($template->id, 'footer2', TRUE); ?>
					</div>
				</div>
				<div class="col-md-2">
					<div class="widget-container" id="footer3">
						<?php echo draw_widgets($template->id, 'footer3', TRUE); ?>
					</div>
				</div>
				<div class="col-md-2">
					<div class="widget-container" id="footer4">
						<?php echo draw_widgets($template->id, 'footer4', TRUE); ?>
					</div>
				</div>
				<div class="col-md-2">
					<div class="widget-container" id="footer5">
						<?php echo draw_widgets($template->id, 'footer5', TRUE); ?>
					</div>
				</div>
				<div class="col-md-2">
					<div class="widget-container" id="footer6">
						<?php echo draw_widgets($template->id, 'footer6', TRUE); ?>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12 copyright">
					<div class="logo-footer center-block">
						<img src="<?=base_url('img/audi-logo.png');?>" class="pull-left"/>
						<p>18088 N Scottsdale Rd</p>
						<p>Phoenix, AZ 85054</p>
						<p>United States</p>
					</div>
					<div class="clearfix"></div>
					<hr />
					<p>Audi North Scottsdale &copy; <?=date('Y');?> | <a href="javascript:void()">Disclaimer</a></p>
				</div>
			</div>
		</div>
	</div>
